var AthleteSettingsController = (function () {
    function AthleteSettingsController($rootScope, $scope, chromeStorageService, AvoidInputKeysService, $mdDialog, $window) {
        $scope.genderList = [{
                type: 'men',
                display: 'Male'
            }, {
        ...
        $scope.avoidInputKeyEdit = function ($event) {
            AvoidInputKeysService.apply($event);
        };
        $scope.profileChanged = function () {
            chromeStorageService.getProfileConfigured().then(function (configured) {
                if (!configured) {
    ...
    AthleteSettingsController.changedAthleteProfileMessage = 'athlete-profile-saved';
    AthleteSettingsController.$inject = ['$rootScope', '$scope', 'ChromeStorageService', 'AvoidInputKeysService', '$mdDialog', '$window'];
    return AthleteSettingsController;
}());
